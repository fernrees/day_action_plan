...
*** =right
>- `r emo::ji("popcorn")`: Popcorn discussions
>- `r emo::ji("speaking_head")`: Breakout rooms
>- `r emo::ji("film_frames")`: Media examples
>- `r emo::ji("performing_arts")`: Rollplays
...
## Guiding Principles `r emo::ji("popcorn")`
<style type="text/css">
textarea.full {
 width: 900px;
 height: 400px;
...
## Keeping in Mind: Goals, Strategies, & Tactics `r emo::ji("speaking_head")`
...
## Documentation Breakout `r emo::ji("speaking_head")`
...
## Day of Roles `r emo::ji("speaking_head")`
